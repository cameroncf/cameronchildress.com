...
export class VitepressThemeStyleCss
  extends Component
  implements IVitepressTemplate
{
  readonly fileContent: string;
  readonly fileName: string = ".vitepress/theme/style.css";
  ...
  constructor(project: VitepressProject) {
    ...
    this.fileContent = defaultTheme
      ...
      : ["", "html {", "  font-family: Arial, Helvetica;", "}", "", ""].join(
          "\n",
        );
  }
}
